...
namespace NeguPi {
  ...
  public:
    ...
    virtual uint8_t readRegister(uint8_t reg, uint8_t hw_addr) = 0;
    virtual void writeRegister(uint8_t reg, uint8_t hw_addr, uint8_t data) = 0;

    virtual uint8_t readBit(uint8_t bit, uint8_t reg, uint8_t hw_addr) = 0;
    virtual void writeBit(uint8_t bit, uint8_t reg, uint8_t hw_addr, uint8_t data) = 0;
